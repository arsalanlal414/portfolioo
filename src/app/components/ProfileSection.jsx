...
const ProfileSection = ({prof}) => {
  ...
  const slide = ["Web Develop", "Web Develop", "Web Develop", "Web Develop","Web Develop","Web Develop","Web Develop", "Web Develop", "Web Develop", "Web Develop", "Web Develop","Web Develop","Web Develop","Web Develop", "Web Develop", "Web Develop", "Web Develop", "Web Develop","Web Develop","Web Develop","Web Develop", "Web Develop", "Web Develop", "Web Develop", "Web Develop","Web Develop","Web Develop","Web Develop"]
      ...
      <div className="flex flex-col md:flex-row w-full justify-between gap-8">
        ...
        <div className="flex flex-col w-full justify-between">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center mt-4 gap-4">
            ...
            <NavigateLinks navUrl="about" navText="More about Me" />
          </div>
        </div>
      </div>
      ...
      <div className="relative overflow-hidden w-full mt-6">
        <div className="flex animate-ticker gap-4 whitespace-nowrap">
          {slide.map((text, index) => (
            <p
              key={index}
              className="flex gap-4 items-center text-sm md:text-[16px] whitespace-nowrap text-gray-700 font-normal"
            >
              <svg
